      ...
      return Stack( clipBehavior: Clip.none, children: [
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Text(title, style: PoppinsBold.copyWith(color: businessController.paymentIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color)),
          ),
        ),
