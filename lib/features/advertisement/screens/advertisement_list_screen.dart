                      ...
                      child: Row(
                        ...
                        children: [
                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Row(children: [
                              Text('ads_id'.tr, style: PoppinsMedium),
                              Text(' # ${advertisementList[index].id}', style: PoppinsBold),
                            ...
                            Text(advertisementList[index].addType!.tr.replaceAll('_', ' ').toTitleCase(), style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor)),
                          ]),
                                ...
                                return PopupMenuItem<PopupMenuModel>(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(option.title.tr, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    ],
                                  ),
                                );
                              }).toList();
