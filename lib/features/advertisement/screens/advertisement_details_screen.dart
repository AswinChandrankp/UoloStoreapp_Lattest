                  ...
                  return SingleChildScrollView(child: Column(children: [
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          AdsCard(
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            subtitleTextStyle : PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall + 1),
                          ),
                          const SizedBox(height:Dimensions.paddingSizeExtraSmall + 2),
                          ...
                          AdsCard(
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            subtitleTextStyle : PoppinsMedium.copyWith(
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text("ads_title".tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                        ...
                        Text("description".tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        advertisementController.advertisementDetailsModel?.cancellationNote != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text("denied_note".tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).colorScheme.error)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        advertisementController.advertisementDetailsModel?.pauseNote != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text("pause_note_title".tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        Text("video".tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault,)): const SizedBox(),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          ...
                          child: Row(children: [
                            ...
                            Expanded(flex: 2,
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Text("profile_image".tr, style: PoppinsBold, maxLines: 1, overflow: TextOverflow.ellipsis),
                            ...
                            Expanded(flex: 3, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text("cover_image".tr, style: PoppinsBold),
