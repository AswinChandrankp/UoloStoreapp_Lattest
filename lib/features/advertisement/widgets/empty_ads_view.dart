  ...
  Widget build(BuildContext context) {
    ...
    return !isAdsEmpty ? SizedBox(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text('no_data_available'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor)),
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text('advertisement_list'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
        const SizedBox(height: Dimensions.paddingSizeSmall),

        Text(
          'uh_oh_You_didnt_created_any_advertisement_yet'.tr,
          textAlign: TextAlign.center,
          style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor),
        ),
