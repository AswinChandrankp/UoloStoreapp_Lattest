          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Padding(
                ...
                child: Text(widget.title.tr, textAlign: TextAlign.center, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ),
              const SizedBox(height: Dimensions.paddingSizeDefault),
              ...
              Padding(
                ...
                child: Text(widget.description.tr, textAlign: TextAlign.center, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor)),
              ),
