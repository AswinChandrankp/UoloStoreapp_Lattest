            ...
            Expanded(
              child: storeController.stockItemList != null ? storeController.stockItemList!.isNotEmpty ? ListView.builder(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('no_item_found'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                ]),
        ...
        child: Row(children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Wrap(crossAxisAlignment: WrapCrossAlignment.center, children: [
                ...
                item.imageFullUrl == null ? Text(
                  ...
                  style: PoppinsMedium.copyWith(color: Colors.green, fontSize: Dimensions.fontSizeExtraSmall),
                ) : const SizedBox(),
              ]),
              ...
              Row(children: [
                ...
                item.imageFullUrl == null && !isAvailable ? Padding(
                  ...
                  child: Text(
                    ...
                    style: PoppinsRegular.copyWith(color: Colors.red, fontSize: Dimensions.fontSizeExtraSmall),
                  ),
                ) : const SizedBox(),
              ]),
          ...
          Padding(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('${'stock'.tr}: ${item.stock}', style: PoppinsMedium.copyWith(color: Theme.of(context).primaryColor),),
