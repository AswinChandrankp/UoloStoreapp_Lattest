...
class _PendingItemScreenState extends State<PendingItemScreen> with SingleTickerProviderStateMixin {
            ...
            child: GetBuilder<StoreController>(builder: (storeController) {
                return Column(children: [
                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: Text('new_product'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(storeController.pendingItem![index].name.toString(), style: PoppinsMedium),
                                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                                    Row(children: [
                                      Text('${'category'.tr} : ', style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                                      Text(storeController.pendingItem![index].categoryIds![index].name.toString(), style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    ]),

                                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                    Text(PriceConverterHelper.convertPrice(storeController.pendingItem![index].price), style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
  ...
  PopupMenuItem getMenuItem(String status, BuildContext context) {
    return PopupMenuItem(
      value: status,
      height: 30,
      child: Text(status.toLowerCase().tr, style: PoppinsRegular.copyWith(
