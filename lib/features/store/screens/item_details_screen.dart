...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    BoxShadow boxShadow = BoxShadow(color: Theme.of(context).disabledColor.withOpacity(0.3), blurRadius: 10);
    double cardRadius = Dimensions.radiusDefault;
    bool isGrocery = Get.find<ProfileController>().profileModel?.stores?.isNotEmpty == true &&
        Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'grocery';
    final isPharmacy = Get.find<ProfileController>().profileModel?.stores?.isNotEmpty == true &&
        Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType == 'pharmacy';
    final isFood = Get.find<SplashController>().getStoreModuleConfig().newVariation!;
    ...
    if (Get.find<ProfileController>().profileModel?.stores?.isNotEmpty == true &&
        Get.find<ProfileController>().profileModel!.stores![0].reviewsSection == true) {
      Get.find<StoreController>().getItemReviewList(item.id);
    }
    Module? module = Get.find<SplashController>().configModel?.moduleConfig?.module;
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Row(children: [
                                InkWell(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(cardRadius),
                                    child: CustomImageWidget(
                                      image: '${item.imageFullUrl ?? ''}', // Safe access
                                      height: 70,
                                      width: 80,
                                      fit: BoxFit.cover,
                                    ),
                          ...
                          Get.find<SplashController>().getStoreModuleConfig().newVariation!
                              ...
                              : VariationView(item: item , stock: module?.stock),
                          (isFood || isGrocery) && (item.nutrition?.isNotEmpty == true) ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                              boxShadow: [boxShadow],
                          ...
                          (isFood || isGrocery) && (item.allergies?.isNotEmpty == true) ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                              boxShadow: [boxShadow],
                          ...
                          isPharmacy && (item.genericName?.isNotEmpty == true) ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                              boxShadow: [boxShadow],
                          ...
                          SizedBox(height: item.addOns?.isNotEmpty == true ? Dimensions.paddingSizeLarge : 0),
                          (item.description != null && item.description!.isNotEmpty) ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                          ...
                          const SizedBox(height: Dimensions.paddingSizeLarge),
                          Get.find<ProfileController>().profileModel?.stores?.isNotEmpty == true && Get.find<ProfileController>().profileModel!.stores![0].reviewsSection == true ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme
                                    ...
                                    ? storeController.itemReviewList!.isNotEmpty
                                        ? SizedBox(
                                            ...
                                            child: ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                return ReviewWidget(
                                                  review: storeController.itemReviewList![index],
                                                  fromStore: false,
                                                  hasDivider: index != storeController.itemReviewList!.length - 1,
                                                );
                                              },
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(
                        child: CustomButtonWidget(
                          onPressed: () {
                            if (Get.find<ProfileController>().profileModel?.stores?.isNotEmpty == true && Get.find<ProfileController>().profileModel!.stores![0].itemSection == true) {
                              Get.toNamed(RouteHelper.getAddItemRoute(item));
                            } else {
                              showCustomSnackBar('this_feature_is_blocked_by_admin'.tr);
                            }
