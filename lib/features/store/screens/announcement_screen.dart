        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child: Column(children: [
              ...
              Row(children: [
                Text("announcement_content".tr, style: PoppinsRegular),
                ...
                JustTheTooltip(
                  ...
                  content: Padding(
                    ...
                    child: Text('this_feature_is_for_sharing_important_information_or_announcements_related_to_the_store'.tr,style: PoppinsRegular.copyWith(color: Theme.of(context).cardColor)),
                  ),
                  child: InkWell(
