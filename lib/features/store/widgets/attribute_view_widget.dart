...
class _AttributeViewWidgetState extends State<AttributeViewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text('attribute'.tr, style: PoppinsBold),
              ...
              child: widget.storeController.attributeList![index].variants.isNotEmpty ? ListView.builder(
                ...
                itemBuilder: (context, i) {
                  return Container(
                    ...
                    child: Row(children: [
                      Text(widget.storeController.attributeList![index].variants[i], style: PoppinsRegular),
                      InkWell(
            ...
            child: Column(children: [
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  ...
                  style: PoppinsRegular, textAlign: TextAlign.center, maxLines: 1,
                ),
              ]),
              const SizedBox(height: Dimensions.paddingSizeSmall),
