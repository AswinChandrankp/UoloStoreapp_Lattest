      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(widget.item.name ?? '', style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
            const SizedBox(height: Dimensions.paddingSizeDefault),

            Text('total_quantity'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
            const SizedBox(height: Dimensions.paddingSizeDefault),
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Expanded(flex: 3, child: Text('variation'.tr, style: PoppinsMedium)),

                  Expanded(flex: 3, child: Text('price'.tr, style: PoppinsMedium)),
                  const SizedBox(width: Dimensions.paddingSizeSmall),

                  Expanded(flex: 3, child: Text('stock'.tr, style: PoppinsMedium)),
                ]),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                    ...
                    return Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Expanded(flex: 3, child: Text(widget.item.variations![index].type!, style: PoppinsRegular)),
