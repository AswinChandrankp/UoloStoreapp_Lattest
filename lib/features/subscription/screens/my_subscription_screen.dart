                    ...
                    child: Column(
                      children: [
                        Text(
                          ...
                          style: PoppinsBold.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeLarge),
                        ),
                        const SizedBox(height: Dimensions.paddingSizeDefault),
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).cardColor, height: 2), textAlign: TextAlign.center,
                          ),
                        ),
                      ],
                    ),
