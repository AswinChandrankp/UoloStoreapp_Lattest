          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(isRenew && (nonSubscription == false) ? 'renew_subscription_plan'.tr : (isRenew && nonSubscription) ? 'choose_subscription_plan'.tr : businessIsCommission ? 'shift_to_new_business_plan'.tr : 'shift_to_new_subscription_plan'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ...
                      child: Stack(children: [
                        ...
                        Positioned(
                          ...
                          child: Column(children: [
                            ...
                            Text(businessIsCommission ? 'commission_base_plan'.tr : activePackage?.packageName ?? '', style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.cyan.shade700), textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis),
                            ...
                            Text(
                              ...
                              style: PoppinsBold.copyWith(fontSize: 25, color:  Colors.cyan.shade700),
                            ),

                            businessIsCommission ? const SizedBox() : Text('${activePackage?.validity} ' 'days'.tr, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                    ...
                    isRenew ? Stack(children: [
                      ...
                      Positioned(
                        ...
                        child: Column(children: [
                          ...
                          Text(package.packageName ?? '', style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).cardColor), textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis),
                          ...
                          Text(
                            ...
                            style: PoppinsBold.copyWith(fontSize: 25, color: Theme.of(context).cardColor),
                          ),

                          Text('${package.validity} ' 'days'.tr, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.white.withOpacity(0.8))),
                          const SizedBox(height: Dimensions.paddingSizeDefault),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('validity'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        Text('${package.validity} ' 'days'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                      ]),
                    ),

                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('price'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        Text(PriceConverterHelper.convertPrice(price), style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                      ]),
                    ),

                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('bill_status'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        Text(isRenew ? 'renew'.tr : 'migrate'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                      ]),
                    ),
                ...
                Padding(
                  padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  child: Row(children: [
                    Text('${'pay_via_online'.tr} ', style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                    Text(
