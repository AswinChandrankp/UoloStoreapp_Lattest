  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
                    ...
                    child: SizedBox(
                      ...
                      child: CustomPaint(
                        ...
                        child: Center(
                          child: Text(
                            '${package.packageName}',
                            style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).cardColor),
      ...
      Text(
        ...
        style: PoppinsBold.copyWith(fontSize: 35, color: color),
      ),

      Text('${package.validity} ' 'days'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
      const SizedBox(height: Dimensions.paddingSizeDefault),
