      ...
      body: GetBuilder<DisbursementController>(builder: (disbursementController) {
        return disbursementController.disbursementReportModel != null ? SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                return Column(children: [
                  InkWell(
                    ...
                    child: ListTile(
                      ...
                      title: Text(PriceConverterHelper.convertPrice(disbursement.disbursementAmount), style: PoppinsMedium),
                      ...
                      trailing: Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Container(
                          ...
                          child: Text(disbursement.status!.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.blue)),
                        ),
            ...
            ) : Padding(padding: const EdgeInsets.only(top: 200), child: Center(child: Text('no_history_available'.tr, style: PoppinsMedium))),
