    ...
    return Scaffold(
      ...
      body: GetBuilder<DisbursementController>(
        builder: (disbursementController) {
                  ...
                  Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      method.isDefault == true ?  Container(
                        ...
                        child: Text('default_method'.tr, style: PoppinsMedium.copyWith(color: Theme.of(context).primaryColor),),
                      ) : InkWell(
                        onTap: () {
                        ...
                        child: Container(
                          ...
                          child: !(disbursementController.isLoading && (index == disbursementController.index))
                              ? Text(
                            'make_default'.tr, style: PoppinsMedium.copyWith(color: Theme.of(context).cardColor),
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: Row(children: [
                                ...
                                const Text(' :  ', style: PoppinsRegular),
          ...
          ) : Center(child: Text('no_method_found'.tr, style: PoppinsMedium)) : const Center(child: CircularProgressIndicator());
        }
      ),
    );
  }
