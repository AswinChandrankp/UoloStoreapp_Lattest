    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Text('attention_please'.tr, style: PoppinsBold.copyWith(color: Colors.black)),
        ]),
          ...
          text: TextSpan(
            ...
            children: [
              TextSpan(
                ...
                style: PoppinsRegular.copyWith(color: Colors.blue, decoration: TextDecoration.underline),
              ),
            ],
          ),
        ),
