      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Row(children: [
              Text('${'review_id'.tr} # ', style: PoppinsRegular),
              Text(review.reviewId != null ? review.reviewId.toString() : '', style: PoppinsBold),
            ]),

            Text(DateConverterHelper.utcToDateTime(review.createdAt!), style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Text(review.itemName ?? '', style: PoppinsBold, overflow: TextOverflow.ellipsis, maxLines: 1),
            ),
            const SizedBox(width: Dimensions.paddingSizeDefault),
        ...
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('reviewer'.tr, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [

              Text(review.customerName ?? '', style: PoppinsBold),

              Text(review.customerPhone ?? '', style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
