        ...
        title: TypeAheadField(
          textFieldConfiguration: TextFieldConfiguration(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor),
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(suggestion.name!, maxLines: 1, overflow: TextOverflow.ellipsis, style: PoppinsRegular.copyWith(
                      color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeLarge,
                    )),
                    Text(PriceConverterHelper.convertPrice(suggestion.price), style: PoppinsRegular.copyWith(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          Text(PriceConverterHelper.convertPrice(itemPrice), style: PoppinsRegular),
                        ]),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('subtotal'.tr, style: PoppinsMedium),
                          Text(PriceConverterHelper.convertPrice(subTotal), style: PoppinsMedium),
                        ]),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                        Row(children: [
                          Expanded(child: Text('discount'.tr, style: PoppinsRegular)),
                          SizedBox(
                            width: 70,
