          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      price > priceWithDiscount ? Text(
                        ...
                        style: PoppinsMedium.copyWith(color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                      ) : const SizedBox(),
                    ]),
                  ),
                ]),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(item!.choiceOptions![index].title!, style: PoppinsMedium),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                      GridView.builder(
                ...
                // Quantity
                Row(children: [
                  Text('quantity'.tr, style: PoppinsMedium),
                  ...
                  Row(children: [
                    ...
                    Text(posController.quantity.toString(), style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    QuantityButtonWidget(
                ...
                Row(children: [
                  Text('${'total_amount'.tr}:', style: PoppinsMedium),
                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                  Text(PriceConverterHelper.convertPrice(priceWithAddons), style: PoppinsBold.copyWith(color: Theme.of(context).primaryColor)),
                ]),
                const SizedBox(height: Dimensions.paddingSizeLarge),
                ...
                isAvailable ? const SizedBox() : Container(
                  ...
                  child: Column(children: [
                    Text('not_available_now'.tr, style: PoppinsMedium.copyWith(
