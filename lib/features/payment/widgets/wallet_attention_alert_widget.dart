        ...
        return Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Text('attention_please'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black)),
            ...
            isOverFlowBlockWarning ? RichText(
              text: TextSpan(
                ...
                style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black),
                children: [
                  TextSpan(
                    ...
                    text: 'pay_the_due'.tr,
                    style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.blue, decoration: TextDecoration.underline),
                  ),
                ],
              ),
            ) : Text('over_flow_warning_message'.tr, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black)),
          ]),
        );
      }
    );
