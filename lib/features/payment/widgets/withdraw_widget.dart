      ...
      Padding(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(PriceConverterHelper.convertPrice(withdrawModel.amount), style: PoppinsMedium),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),

            Text('${'transferred_to'.tr} ${withdrawModel.bankName}', style: PoppinsRegular.copyWith(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Text(withdrawModel.status!.tr, style: PoppinsRegular.copyWith(
