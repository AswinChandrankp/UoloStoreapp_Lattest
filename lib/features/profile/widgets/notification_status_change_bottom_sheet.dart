    ...
    return Container(
      ...
      child: GetBuilder<AuthController>(builder: (authController) {
        return Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('are_you_sure'.tr, style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: PoppinsRegular.copyWith(color: Theme.of(context).hintColor), textAlign: TextAlign.center,
            ),
          ),
