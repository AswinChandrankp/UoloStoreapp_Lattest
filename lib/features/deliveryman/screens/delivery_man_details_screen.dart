            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    '${deliveryMan.fName} ${deliveryMan.lName}', style: PoppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ...
                  Row(children: [
                    ...
                    Text(deliveryMan.avgRating!.toStringAsFixed(1), style: PoppinsRegular),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Text(
              ...
              Column(
                ...
                children: [
                  Text('reviews'.tr, style: PoppinsMedium),
                  ...
                  dmController.dmReviewList != null ? dmController.dmReviewList!.isNotEmpty ? ListView.builder(
                    ...
                    child: Center(child: Text(
                      'no_review_found'.tr, style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor),
                    )),
                  ) : const Padding(
