        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            widget.verify! ? Column(children: [
              ...
              Text('enter_otp_number'.tr, style: PoppinsRegular, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
            ...
            widget.verify! ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              orderController.hideNotificationButton ? const SizedBox() : InkWell(
                ...
                child: Text(
                  'resend_it'.tr,
                  style: PoppinsMedium.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
                ),
              )
            ]) : const SizedBox(),
            const SizedBox(height: Dimensions.paddingSizeLarge),
