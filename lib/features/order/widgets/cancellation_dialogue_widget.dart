          ...
          return SizedBox(
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Column(children: [
                  Text('select_cancellation_reasons'.tr, style: PoppinsMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge)),
                    ...
                    child: ListTile(
                      ...
                      title: Row(
                        children: [
                          ...
                          Flexible(child: Text(orderController.orderCancelReasons![index].reason!, style: PoppinsRegular, maxLines: 3, overflow: TextOverflow.ellipsis)),
                        ],
                      ),
                    ),
                  );
