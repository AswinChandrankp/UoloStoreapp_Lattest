    ...
    return Expanded(
      child: Padding(
        ...
        child: Column(children: [
          ...
          Text(title, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor)),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(count.toString(), style: PoppinsMedium.copyWith(
