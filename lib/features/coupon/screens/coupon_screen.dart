                              ...
                              children: [
                                ...
                                Center(
                                  child: Text(couponController.coupons![index].discountType == 'percent' ? '%' : '\$',
                                    style: PoppinsBold.copyWith(fontSize: 18, color: Theme.of(context).cardColor),
                                  ),
                                ),
                              ],
                            ),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Text('${'code'.tr}: ${couponController.coupons![index].code!}', style: PoppinsMedium),
                                const SizedBox(height: 5),

                                Text('${'total_users'.tr}: ${couponController.coupons![index].totalUses}', style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                                const SizedBox(height: 5),
