      ...
      return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Text('choose_your_language'.tr, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),

            Text('choose_your_language_to_proceed'.tr, style: PoppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
