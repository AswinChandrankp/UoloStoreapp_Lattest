  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      widget.title ? Row(children: [
        ...
        widget.isEnabled! ? const SizedBox() : Text('(${'non_changeable'.tr})', style: PoppinsRegular.copyWith(
          fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).colorScheme.error,
        )),

        widget.isRequired ? Text('*', style: PoppinsBold.copyWith(color: Theme.of(context).primaryColor)) : const SizedBox(),
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: widget.amountIcon ? Padding(
              ...
              child: Text(Get.find<SplashController>().configModel!.currencySymbol!, style: PoppinsBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
            ) : null,
          ),
