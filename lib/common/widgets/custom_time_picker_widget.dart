        ...
        child: Stack(clipBehavior: Clip.none, children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(
                _myTime != null ? DateConverterHelper.convertStringTimeToTime(_myTime!) : ' - -  : - - ${'min'.tr}', style: PoppinsRegular.copyWith(color: _myTime != null ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeDefault),
              )),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text(widget.title, style: PoppinsRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
            ),
          ),
